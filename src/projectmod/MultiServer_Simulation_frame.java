...
public class MultiServer_Simulation_frame implements ActionListener{
    JFrame frame;
    Container container;
    JButton start,back;
    ...
    public MultiServer_Simulation_frame() {
        frame = new JFrame("Single Queue Multiple Servers");
    ...
    public void actionPerformed(ActionEvent e) {
         if(e.getSource() == this.start){
           ...
           MultiServer_Simulation MS = new MultiServer_Simulation(customer_number);
           MultiServer_table t = new  MultiServer_table(MS.Simulate());
           }
           catch(Exception ex){
